...
export default async function ProfilePage() {
  ...
  const appearance = record(profile.appearance);
  ...
  return (
    <div className="mx-auto max-w-[1240px] pb-12">
      ...
      <section
        ...
        className={`relative overflow-hidden rounded-[26px] bg-[#09090c] ${
          verified
      ...
      >
        {verified ? (
          <>
            <div
              ...
              style={{
                background: `
                  radial-gradient(
                    circle at 78% 10%,
                    color-mix(in srgb, var(--profile-primary) 22%, transparent),
                    transparent 37%
                  ),
                  radial-gradient(
                    circle at 16% 95%,
                    color-mix(in srgb, var(--profile-secondary) 15%, transparent),
                    transparent 38%
                  ),
                  linear-gradient(
                    135deg,
                    ...
                    transparent 45%,
                    color-mix(in srgb, var(--profile-secondary) 5%, transparent)
                  )
                `,
              }}
            />
            ...
            <div
              className="pointer-events-none absolute -right-24 -top-36 h-[430px] w-[430px] rounded-full blur-[115px]"
              style={{
                background:
            ...
            <div
              className="pointer-events-none absolute -bottom-40 -left-20 h-[340px] w-[340px] rounded-full blur-[110px]"
              style={{
                background:
